...
Route::get('admin', array('before' => 'auth', 'do' => function() {
	...
	return View::make('pages.newpost')->with('user', $user);
}));
...
/*
|--------------------------------------------------------------------------
| HANDLE THE THE REGISTRATION FORM
|--------------------------------------------------------------------------
*/

Route::post('register', function() {
	// let's get the new user from the POST data
	// this is much safer than using mass assignment
	$new_user = array(
		'username' 	=> Input::get('username'),
		'password' 	=> Input::get('password'),
	...
	// I'm sure you can come up with better ones
	$rules = array(
		'username' 	=> 'required|min:3|max:128|alpha_num',
